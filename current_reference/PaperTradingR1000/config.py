...
CANDIDATE_HISTORY_FILE = REPORTS_DIR / "candidate_history.jsonl"
...
MOBILE_SNAPSHOT_CLIENT_ID = int(os.environ.get("TRADINGBOTR1000_MOBILE_SNAPSHOT_CLIENT_ID", "1006"))
EXECUTION_MONITOR_CLIENT_ID = int(os.environ.get("TRADINGBOTR1000_EXECUTION_MONITOR_CLIENT_ID", "1007"))
PAPER_PNL_START_DATE = os.environ.get("TRADINGBOTR1000_PAPER_PNL_START_DATE", "2026-09-01").strip()
